...
### Documentação
- `ARQUITETURA_PROJETO.md` — §12 (Modelo de Dados), §4 (Schema)
...
3. **Gestão de contexto:**
   - Nunca abrir `ARQUITETURA_PROJETO.md` inteiro — usar grep primeiro
   - Buscar seção específica: `grep -n "§12" ARQUITETURA_PROJETO.md`
