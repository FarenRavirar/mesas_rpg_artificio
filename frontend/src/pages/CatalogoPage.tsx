...
import { RotateCcw, Search, ShieldCheck, Star, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const CatalogoPage = () => {
  ...
  return (
    <main className="bg-[var(--color-artificio-blue)] text-white min-h-screen">
      ...
      <div className="sticky top-16 z-30 bg-[#0d1a30]/95 backdrop-blur-md border-b border-white/10">
        <div className="container mx-auto px-6 py-4">
          ...
          <div className="flex items-center gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
            ...
            <div className="relative min-w-[200px] flex-1 max-w-[300px]">
              ...
              <input
                ...
                placeholder="Buscar..."
                className="w-full rounded-lg bg-[#13213f] border border-white/10 pl-9 pr-3 py-2 text-sm outline-none focus:border-[var(--color-artificio-orange)] transition-colors"
              />
            </div>
            ...
            <select
              ...
              className="rounded-lg bg-[#13213f] border border-white/10 px-3 py-2 text-sm outline-none focus:border-[var(--color-artificio-orange)] transition-colors cursor-pointer min-w-[140px]"
            >
            ...
            <select
              ...
              className="rounded-lg bg-[#13213f] border border-white/10 px-3 py-2 text-sm outline-none focus:border-[var(--color-artificio-orange)] transition-colors cursor-pointer min-w-[120px]"
            >
            ...
            <select
              ...
              className="rounded-lg bg-[#13213f] border border-white/10 px-3 py-2 text-sm outline-none focus:border-[var(--color-artificio-orange)] transition-colors cursor-pointer min-w-[100px]"
            >
            ...
            {activeFiltersCount > 0 && (
              <button
                ...
                className="flex items-center gap-1 px-3 py-2 rounded-lg border border-white/20 bg-white/5 hover:bg-white/10 text-sm text-white/80 hover:text-white transition-colors whitespace-nowrap"
              >
          ...
          {/* Linha 2: Selos + Estilos (colapsável em mobile) */}
          <div className="flex items-center gap-2 mt-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
            {/* Selos */}
            <button
              type="button"
      ...
      <section className="container mx-auto px-6 py-8">
        ...
        {!isLoading && tables.length === 0 ? (
          ...
          <>
            {/* GRID - 3 colunas fixo no desktop */}
