...
export const GestaoPage = () => {
  ...
  // CORREÇÃO DT-AGG-03: Remover aba 'tables' (dependia de aggregator)
  const [activeTab, setActiveTab] = useState<'systems' | 'crud'>('crud');
  // REMOVIDO: const [selectedCandidate, setSelectedCandidate] = useState<AggregatorCandidate | null>(null);
