...
describe('parseDiscordAnnouncement', () => {
    ...
    it('creates a reviewable draft from a forum starter when embed text provides the body', () => {
        ...
        expect(draft?.missing_fields).toEqual(expect.arrayContaining(['system_name']));
    ...
    it('ignores real Covil forum starter titles when only the thread name is available', () => {
        ...
        const drafts = titles.map((threadName, index) => (0, parseDiscordAnnouncement_1.parseDiscordAnnouncement)(makeMessage({
    ...
    it('matches systems by specific names before generic aliases and version suffixes', () => {
        ...
        const dndDraft = (0, parseDiscordAnnouncement_1.parseDiscordAnnouncement)(makeMessage({
        ...
        const tormentaDraft = (0, parseDiscordAnnouncement_1.parseDiscordAnnouncement)(makeMessage({
