...
const devFeedback_1 = __importDefault(require("./routes/devFeedback"));
const devFeedbackAdmin_1 = __importDefault(require("./routes/devFeedbackAdmin"));
...
app.use('/api/v1/dev-feedback', devFeedback_1.default);
...
app.use('/api/v1/admin', devFeedbackAdmin_1.default);
