...
describe('scoreSystemCandidates', () => {
    ...
    it('recommends merge when the suggested edition already exists under the matched parent', () => {
        const r = (0, systemSuggestionCandidates_1.scoreSystemCandidates)('D&D 2024', SYSTEMS, ALIASES);
    ...
    it('does not match unrelated phrase acronyms without explicit acronym signal', () => {
        const r = (0, systemSuggestionCandidates_1.scoreSystemCandidates)('Curse of Strahd', [{ id: 'changeling', name: 'Changeling', name_pt: null, slug: 'changeling', path_slug: 'changeling', node_type: 'system', parent_id: null }], [{ system_id: 'changeling', alias: 'Changeling: o sonhar' }]);
        expect(r.candidates).toEqual([]);
        expect(r.recommended_action).toBe('create_system');
    });
