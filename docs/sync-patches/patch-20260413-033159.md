...
- `.agents/default-rules.md`
- `.agents/workflows/GIT_WORKFLOW.md`
- `.agents/workflows/PRE-FLIGHT_CHECKLIST.md`
- `.agents/workflows/PRE_DEPLOY_CHECKLIST.md`
- `.gemini/auditoria_2026-04-08.md`
- `.gemini/default-rules.md`
- `.gemini/workflows/GIT_WORKFLOW.md`
- `.gemini/workflows/PRE-FLIGHT_CHECKLIST.md`
- `.gemini/workflows/PRE_DEPLOY_CHECKLIST.md`
- `RESUMO_EXECUCAO.md`
- `docker-compose.beta.yml.backup`
