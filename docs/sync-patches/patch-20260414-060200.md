...
> Data: 2026-04-14T06:02:00.003Z
> Arquivos alterados no merge: 28
...
- `docs/sync-patches/patch-20260413-195245.md`
...
- `frontend/src/utils/tableBadges.ts`
- `scratch_index_bundle.js`
- `sessoes/resumo_09-04_diagnostico-travamento.md`
- `sessoes/resumo_09-04_inicio-sessao.md`
- `sessoes/resumo_09-04_limpeza-documentacao.md`
- `sessoes/resumo_11-04_descricao-editorial.md`
