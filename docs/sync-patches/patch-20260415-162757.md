...
- `GUIA_AGENTES_24H.md`
- `RESUMO_EXECUCAO.md`
- `RESUMO_EXECUCAO_antigravity.md`
- `TODO_OPERACIONAL.md`
- `ambiente_atual_mesas.md`
- `sessoes/resumo_11-04_limpeza-aggregator.md`
- `sessoes/resumo_11-04_manutencao-documentacao.md`
- `sessoes/resumo_12-04_fix-edit-mesa-vazia.md`
