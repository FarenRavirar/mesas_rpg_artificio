...
> Data: 2026-04-15T23:27:23.317Z
> Arquivos alterados no merge: 40
...
- `backend/dist/routes/scenarios.js`
- `backend/dist/routes/systemSuggestions.js`
- `backend/dist/routes/systems.js`
- `backend/dist/routes/tables.js`
- `backend/dist/routes/vttPlatforms.js`
- `backend/dist/server.js`
- `backend/src/db/types.ts`
- `backend/src/repositories/tableRepository.ts`
- `backend/src/routes/communicationPlatforms.ts`
...
- `frontend/src/hooks/useCommunicationPlatforms.ts`
- `frontend/src/modules/admin/platforms/PlatformsPage.tsx`
